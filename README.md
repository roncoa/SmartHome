...
Per scaricare l'ultima release clicca [**qui**](https://github.com/roncoa/SmartHome/releases/latest) [![GitHub version](https://img.shields.io/github/release/roncoa/smarthome.svg)](https://github.com/roncoa/smarthome/releases/latest)
