...
#define Flag_inversione_Status_LED   0              // Inversione del segnale di uscita Status_LED (0=normale - 1=invertito) nodemcu=1 - ESP01=1 - SONOFFDUAL=1 - elctrodragon=0 - hipposwitch=0
