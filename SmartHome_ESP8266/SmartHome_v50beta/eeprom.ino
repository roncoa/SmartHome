/*
  ...
  102  -> SmartHome Termostato 1 - TERMOSTATO (float 4th byte)
  103  -> SmartHome Termostato 1 - TERMOSTATO (float 3th byte)
  104  -> SmartHome Termostato 1 - TERMOSTATO (float 2nd byte)
  105  -> SmartHome Termostato 1 - TERMOSTATO (float 1st byte)
...
void EEPROM_clear_reset() {                                              // Impulso la EEPROM e resetto l'ESP
  EEPROM.begin(512);
