...
void setup_web() {
  ...
  for (int i = 0; i < Impulso_nodi; i++) {
    webPage += "<p>" + Impulso[i].topic + "  <a href=\"can" + (String) (i+1) + "on\"><button>ON</button></a></p>";
  }
  for (int i = 0; i < Temporizzatore_nodi; i++) {
    webPage += "<p>" + Temporizzatore[i].topic + "  <a href=\"tim" + (String) (i+1) + "on\"><button>ON</button></a></p>";
  }
