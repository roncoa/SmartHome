...
void setup_web() {
  ...
  HttpServer.on("/reset", []() {
    ...
    HttpServer.handleClient();
    Debug_MSG_LN("Message arrived [web] /reset");
    Debug_MSG_LN("RIAVVIO L'ESP (da web)");
    EEPROM_clear_reset();
  });
  ...
  for (int i = 0; i < Tapparella_nodi; i++)
  {
    ...
    HttpServer.on("/tap" + (String)i + "meno", [i]() {
      Debug_MSG_LN("Message arrived [web] /tap" + (String)i +  "meno");
      Tapparella[i].tempo_max = Tapparella[i].tempo_max - 1000;
  ...
  for (int i = 0; i < Interruttore_nodi; i++) {
    HttpServer.on("/int" + (String)i + "on", [i]() {
      Debug_MSG_LN("Message arrived [web] /int" + (String)i + "on");
    ...
    HttpServer.on("/int" + (String)i + "off", [i]() {
      Debug_MSG_LN("Message arrived [web] /int" + (String)i + "off");
  ...
  for (int i = 0; i < Impulso_nodi; i++) {
    HttpServer.on("/imp" + (String)i + "on", [i]() {
      Debug_MSG_LN("Message arrived [web] /imp" + (String)i + "on");
    ...
    HttpServer.on("/imp" + (String)i + "menokey", [i]() {
      Debug_MSG_LN("Message arrived [web] /imp" + (String)i + "menokey");
      menokey();
      handle_IndexRedir();
    });
    HttpServer.on("/imp" + (String)i + "clearkey", [i]() {
      Debug_MSG_LN("Message arrived [web] /imp" + (String)i + "clearkey");
      clearkey();
      handle_IndexRedir();
    });
  ...
  for (int i = 0; i < Temporizzatore_nodi; i++) {
    HttpServer.on("/tem" + (String)i + "on", [i]() {
      Debug_MSG_LN("Message arrived [web] /tem" + (String)i + "on");
    ...
    HttpServer.on("/tem" + (String)i + "piu", [i]() {
      Debug_MSG_LN("Message arrived [web] /tem" + (String)i +  "piu");
    ...
    HttpServer.on("/tem" + (String)i + "meno", [i]() {
      Debug_MSG_LN("Message arrived [web] /tem" + (String)i +  "meno");
      Temporizzatore[i].tempo = Temporizzatore[i].tempo - 1000;
    ...
    HttpServer.on("/tem" + (String)i + "piupiu", [i]() {
      Debug_MSG_LN("Message arrived [web] /tem" + (String)i +  "piupiu");
    ...
    HttpServer.on("/tem" + (String)i + "menomeno", [i]() {
      Debug_MSG_LN("Message arrived [web] /tem" + (String)i +  "menomeno");
      Temporizzatore[i].tempo = Temporizzatore[i].tempo - 30000;
      if (Temporizzatore[i].tempo < 1000) Temporizzatore[i].tempo = 1000;
      EEPROM_WRITE_Temporizzatore_tempo(i);
      Stato_TEM(i);
  ...
  for (int i = 0; i < Termostato_nodi; i++) {
    HttpServer.on("/ter" + (String)i + "on", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i + "on");
    ...
    HttpServer.on("/ter" + (String)i + "off", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i + "off");
    ...
    HttpServer.on("/ter" + (String)i + "man", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i + "man");
    ...
    HttpServer.on("/ter" + (String)i + "auto", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i + "auto");
    ...
    HttpServer.on("/ter" + (String)i + "crono", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i + "crono");
      Termostato[i].AUTO = false;
    ...
    for (int ii = 0; ii <= 23; ii++) {
      HttpServer.on("/ter" + (String)i + "piuora" + (String)ii, [i, ii]() {
        Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "piuora" + (String)ii);
      ...
      HttpServer.on("/ter" + (String)i + "menoora" + (String)ii, [i, ii]() {
        Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "menoora" + (String)ii);
        Termostato[i].crono[ii] -= 1;
    ...
    HttpServer.on("/ter" + (String)i + "piu", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "piu");
    ...
    HttpServer.on("/ter" + (String)i + "meno", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "meno");
      Termostato[i].ta = Termostato[i].ta - 0.1;
    ...
    HttpServer.on("/ter" + (String)i + "piut3", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "piut3");
      Termostato[i].t3 += 0.1;
    ...
    HttpServer.on("/ter" + (String)i + "menot3", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "menot3");
      Termostato[i].t3 -= 0.1;
    ...
    HttpServer.on("/ter" + (String)i + "piut2", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "piut2");
      Termostato[i].t2 += 0.1;
    ...
    HttpServer.on("/ter" + (String)i + "menot2", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "menot2");
      Termostato[i].t2 -= 0.1;
    ...
    HttpServer.on("/ter" + (String)i + "piut1", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "piut1");
      Termostato[i].t1 += 0.1;
    ...
    HttpServer.on("/ter" + (String)i + "menot1", [i]() {
      Debug_MSG_LN("Message arrived [web] /ter" + (String)i +  "menot1");
      Termostato[i].t1 -= 0.1;
  ...
  for (int i = 0; i < Power_nodi; i++) {
    HttpServer.on("/pow" + (String)i + "zero", [i]() {
      Debug_MSG_LN("Message arrived [web] /pow" + (String)i +  "zero");
    ...
    HttpServer.on("/pow" + (String)i + "KWh", [i]() {
      Debug_MSG_LN("Message arrived [web] /pow" + (String)i +  "KWh");
      KWh = true;
      EEPROM_WRITE_Power_Wh_KWh();
      handle_IndexRedir();
    });
    HttpServer.on("/pow" + (String)i + "Wh", [i]() {
      Debug_MSG_LN("Message arrived [web] /pow" + (String)i +  "Wh");
      KWh = false;
      EEPROM_WRITE_Power_Wh_KWh();
      handle_IndexRedir();
    });
