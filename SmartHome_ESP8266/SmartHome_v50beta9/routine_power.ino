...
void ACK_Power() {
  for (int i = 0; i < Power_nodi; i++) {
    ...
    JSONdoc["NODO"] = Power_DEF;
    JSONdoc["Topic"] = Power[i].topic;
    JSONdoc["Topic_ACK"] = Power[i].topic_ACK;
...
void Stato_POW(int i) {
  ...
  JSONdoc["A"] = Power[i].A;
  JSONdoc["W"] = Power[i].W;
  JSONdoc["VA"] = Power[i].VA;
  JSONdoc["VAr"] = Power[i].VAr;
  JSONdoc["PF"] = Power[i].PF;
  JSONdoc["freq"] = Power[i].freq;
  JSONdoc["Wh"] = Power[0].Wh;
  JSONdoc["WhParziale"] = Power[0].Wh_parziale;
  JSONdoc["WhOggi"] = Power[0].Wh_oggi;
  JSONdoc["WhSett"] = Power[0].Wh_settimanale;
  JSONdoc["WhMese"] = Power[0].Wh_mensile;
  JSONdoc["WhIeri"] = Power[0].Wh_ieri;
  JSONdoc["WhSettSc"] = Power[0].Wh_settimana_scorsa;
  JSONdoc["WhMeseSc"] = Power[0].Wh_mese_scorso;
  JSONdoc["KWh"] = (String)(Power[0].Wh / 1000);
  JSONdoc["KWhParziale"] = (String)(Power[0].Wh_parziale / 1000);
  JSONdoc["KWhOggi"] = (String)(Power[0].Wh_oggi / 1000);
  JSONdoc["KWhSett"] = (String)(Power[0].Wh_settimanale / 1000);
  JSONdoc["KWhMese"] = (String)(Power[0].Wh_mensile / 1000);
  JSONdoc["KWhIeri"] = (String)(Power[0].Wh_ieri / 1000);
  JSONdoc["KWhSettSc"] = (String)(Power[0].Wh_settimana_scorsa / 1000);
  JSONdoc["KWhMeseSc"] = (String)(Power[0].Wh_mese_scorso / 1000);
  String payload = "";
  serializeJson(JSONdoc, payload);
