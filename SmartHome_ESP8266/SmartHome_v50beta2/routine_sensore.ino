...
void setup_Sensore() {
  ...
  Sensore[0].topic_ACK += "/ack";
  Sensore[1].topic_ACK += "/ack";
  Sensore[2].topic_ACK += "/ack";
  Sensore[3].topic_ACK += "/ack";
  Sensore[4].topic_ACK += "/ack";
  Sensore[5].topic_ACK += "/ack";
  Sensore[6].topic_ACK += "/ack";
  Sensore[7].topic_ACK += "/ack";
  Sensore[8].topic_ACK += "/ack";
  Sensore[9].topic_ACK += "/ack";
