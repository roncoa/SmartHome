...
// Tipo nodo
#define TIPO_NODO         "CAN"                   // "TAP"->tapparella "TEM"->temperatura "INT"->interruttore "CAN"->cancello

// MQTT topic
#define Cancello_Topic  "cancello/xxxxx"        // Cancello_Topic
...
#endif
  Serial.println();
  Serial.println(" ***** SmartHome cancello v3*****");
