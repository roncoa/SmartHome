...
// MQTT server
const char* ssid = "xxxxxxxxxxx" ;                // WIFI SSID
const char* password = "xxxxxxxx";                // WIFI password
const char* mqtt_server = "xxx.cloudmqtt.com";    // MQTT server
const char* mqtt_user = "xxxxxxxx";               // MQTT user
const char* mqtt_password = "xxxxxxxxxxxx";       // MQTT password
const int   mqtt_port = xxxxx;                    // MQTT port
...
#define SONOFF_DUAL                               // Commentare l'hardware non corrente
...
// MQTT topic
#define Tapparella_Topic  "tapparella/1P/sonoffX"        // Tapparella_Topic (non usare underscore "_")
...
#define Flag_inversione_RELE        0             // Inversione del segnale di uscita RELE       (0=normale - 1=invertito)
#define Flag_inversione_Status_LED  1             // Inversione del segnale di uscita Status_LED (0=normale - 1=invertito)
#define Status_LED                  13            // BUILTIN_LED : nodemcu->GPIO16 - ESP01->GPIO1(TX) - SONOFFDUAL->GPIO13
#define RELE_tapparella_SU          14            // RELE abilitazione
#define RELE_tapparella_GIU         15            // RELE SU/GIU
#define BOTTONE_tapparella_SU       4             // Pulsante tapparella SU
#define BOTTONE_tapparella_GIU      5             // Pulsante tapparella GIU
#define PullUp                                    // resistenza PullUp verso vcc
//#define PullDown                                // resistenza PullDown verso gnd
